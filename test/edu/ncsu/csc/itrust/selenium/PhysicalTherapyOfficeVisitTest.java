...
public class PhysicalTherapyOfficeVisitTest extends iTrustSeleniumTest {
	...
	/**
	 * Test for creating new physcial therapy office visit with order
	 * 
	 * @throws Exception
	 */
	public void testCreatePhysicalTherapyOfficeVisit() throws Exception {
		...
		// Verify that the newly created office visit is present in the Prior
		// Office Visits list
		assertTrue(driver.getPageSource().contains("10/14/2015"));
	}

	/**
	 * test for view physical therapy office visit for generic HCP (none
	 * orthopedic, none physical therapist)
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test for editing physical therapy office visit
	 * 
	 * @throws Exception
	 */
