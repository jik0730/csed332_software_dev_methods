...
/**
 * Bean for Scheduled Orthopedic Office Visits.
 * Holds all of the data needed for a scheduled Orthopedic Office Visit.
 */
public class OrthopedicScheduleOVRecordBean {

	/**The mid of the patient.*/
	private long patientmid;
	/**The mid of the doctor.*/
	private long doctormid;
	/**The scheduled Orthopedic office visit id.*/
	private long oid;
	/**The time of the scheduled Orthopedic office visit.*/
	private Timestamp date;
	/**The last name of the orthopedic.*/
	private String docLastName;
	/**The first name of the opthopedic.*/
	private String docFirstName;
	/**The comment attached to the office visit request.*/
	private String comment;
	/**The status of the requested orthopedic office visit.*/
	...
	/**
	 * Method used to compute the hashcode for a OrthopedicOVRecordBean. 
	 * @return true if the OrthopedicOVRecordBeans are equal, false otherwise.
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	/**
	 * Method used to determine if OrthopedicOVRecordBeans are equal. 
	 * @return true if the OrthopedicOVRecordBeans are equal, false otherwise.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrthopedicScheduleOVRecordBean other = (OrthopedicScheduleOVRecordBean) obj;
		if (comment == null) {
	...
	public String toString() {
		return "OrthopedicScheduleOVRecordBean [patientmid=" + patientmid
