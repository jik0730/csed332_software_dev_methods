...
<%@page import="edu.ncsu.csc.itrust.action.AddOrthopedicScheduleOVAction"%>
...
<%
	pageTitle = "iTrust - Add Orthopedic Office Visit Request";
%>
<%@include file="/header.jsp"%>
<%
	ViewPersonnelAction personnelAction = new ViewPersonnelAction(prodDAO, loggedInMID);
	AddOrthopedicScheduleOVAction addAction = new AddOrthopedicScheduleOVAction(prodDAO,loggedInMID);
	...
	if (request.getParameter("request") != null) {
		OrthopedicScheduleOVRecordBean bean = new OrthopedicScheduleOVRecordBean();
		...
		if(!msg.contains("ERROR")){
			...
			msg = "Your Orthopedic Office Visit Request has been saved and is pending.";
		}	
	}
%>
<h1>Request an Orthopedic Office Visit</h1>
<%
	if (msg.contains("ERROR")) {
%>
...
%>
<form action="addOrthopedicOVRequest.jsp" method="post">
	<p>HCP:</p>
	<select name="lhcp">
		<%
