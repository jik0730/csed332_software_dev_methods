...
/**
 * A loader for OrthopedicScheduleOVRecordBean.
 * 
 * Loads in information to/from beans using ResultSets and PreparedStatements. Use the superclass to enforce consistency. 
 * For details on the paradigm for a loader (and what its methods do), see {@link BeanLoader}
 */
public class OrthopedicScheduleOVRecordLoader implements BeanLoader<OrthopedicScheduleOVRecordBean>{

	/**
	 * Returns a list of beans with data from a ResultSet.
	 * @param rs ResultSet containing data from the database
	 * @return A list of OrthopedicScheduleOVRecordBean created from the ResultSet parameter.
	 * @throws SQLException thrown when there is a error resulting from accessing a field of the ResultSet.
	 */
	public List<OrthopedicScheduleOVRecordBean> loadList(ResultSet rs) throws SQLException {
		List<OrthopedicScheduleOVRecordBean> list = new ArrayList<OrthopedicScheduleOVRecordBean>();
		while (rs.next()) {
	 ...
	 * @throws SQLException thrown when there is a error resulting from accessing a field of the ResultSet.
	 */
	private void loadCommon(ResultSet rs, OrthopedicScheduleOVRecordBean p) throws SQLException {
	 ...
	 * @throws SQLException thrown when there is a error resulting from accessing a field of the ResultSet.
	 */
	public OrthopedicScheduleOVRecordBean loadSingle(ResultSet rs) throws SQLException {
		OrthopedicScheduleOVRecordBean p = new OrthopedicScheduleOVRecordBean();
		loadCommon(rs, p);
		return p;
	}
	
	/**
	 * Loads values into the parameters of a preparedStatement from the given OrthopedicOVRecordBean.
	 * @param ps The PreparedStatement that will have it's parameters filled in.
	 * @param p The OrthopedicOVRecordBean used to fill in the parameters of the preparedStatement.
	 * @return The preparedStatement with the parameters filled in.
	 * @throws SQLException thrown when there is a error resulting from accessing a field of the ResultSet.
	 */
	public PreparedStatement loadParameters(PreparedStatement ps, OrthopedicScheduleOVRecordBean p) throws SQLException {
		int i = 1;
