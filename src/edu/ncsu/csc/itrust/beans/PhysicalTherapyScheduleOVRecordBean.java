...
/**
 * Bean for Scheduled PhysicalTherapy Office Visits.
 * Holds all of the data needed for a scheduled PhysicalTherapy Office Visit.
 */
public class PhysicalTherapyScheduleOVRecordBean {

	/**The mid of the patient.*/
	private long patientmid;
	/**The mid of the doctor.*/
	private long doctormid;
	/**The scheduled PhysicalTherapy office visit id.*/
	private long oid;
	/**The time of the scheduled PhysicalTherapy office visit.*/
	private Timestamp date;
	/**The last name of the physicalTherapy.*/
	private String docLastName;
	/**The first name of the opthopedic.*/
	private String docFirstName;
	/**The comment attached to the office visit request.*/
	private String comment;
	/**The status of the requested physicalTherapy office visit.*/
	 ...
	 * @return true if the PhysicalTherapyOVRecordBeans are equal, false otherwise.
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PhysicalTherapyScheduleOVRecordBean other = (PhysicalTherapyScheduleOVRecordBean) obj;
		if (comment == null) {
	...
	public String toString() {
		return "PhysicalTherapyScheduleOVRecordBean [patientmid=" + patientmid
