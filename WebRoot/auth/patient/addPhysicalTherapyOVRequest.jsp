...
<%@page import="edu.ncsu.csc.itrust.action.AddPhysicalTherapyScheduleOVAction"%>
...
<%
	pageTitle = "iTrust - Add PhysicalTherapy Office Visit Request";
%>
<%@include file="/header.jsp"%>
<%
	ViewPersonnelAction personnelAction = new ViewPersonnelAction(prodDAO, loggedInMID);
	AddPhysicalTherapyScheduleOVAction addAction = new AddPhysicalTherapyScheduleOVAction(prodDAO,loggedInMID);
	...
	if (request.getParameter("request") != null) {
		PhysicalTherapyScheduleOVRecordBean bean = new PhysicalTherapyScheduleOVRecordBean();
		...
		if(!msg.contains("ERROR")){
			addAction.addPhysicalTherapyOV(bean);
			msg = "Your PhysicalTherapy Office Visit Request has been saved and is pending.";
		}	
	}
%>
<h1>Request an PhysicalTherapy Office Visit</h1>
<%
	if (msg.contains("ERROR")) {
%>
...
%>
<form action="addPhysicalTherapyOVRequest.jsp" method="post">
	<p>HCP:</p>
	<select name="lhcp">
		<%
