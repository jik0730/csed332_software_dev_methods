...
<%
pageTitle = "iTrust - View Scheduled PhysicalTherapy Office Visits";
%>

<%@include file="/header.jsp" %>
<div align=center>
	<h2>My Scheduled PhysicalTherapy Office Visits</h2>
<%
	...
	List<PhysicalTherapyScheduleOVRecordBean> requests = scheduleAction.getPhysicalTherapyScheduleOVByPATIENTMID(loggedInMID);
...
<%		 
		int index = 0;
		for(PhysicalTherapyScheduleOVRecordBean a : requests) { 
			String comment = "No Comment";
			if(a.getComment() != null)
				comment = "<a href='viewPhysicalTherapyScheduledOV.jsp?oid="+a.getOid()+"'>Read Comment</a>";
