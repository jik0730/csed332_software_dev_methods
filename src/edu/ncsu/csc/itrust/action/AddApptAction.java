...
public class AddApptAction extends ApptAction {
	...
	/**
	 * Appointment add and return result string.
	 * 
	 * @param appt
	 * @param ignoreConflicts
	 * @return String add result
	 * @throws FormValidationException
	 * @throws SQLException
	 * @throws DBException
	 */
	public String addAppt(ApptBean appt, boolean ignoreConflicts)
			throws FormValidationException, SQLException, DBException {
