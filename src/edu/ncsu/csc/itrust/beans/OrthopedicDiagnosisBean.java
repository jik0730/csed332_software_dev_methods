...
/**
 * A bean for storing data about Diagnosis for Orthopedic.
 * 
 ...
 */
public class OrthopedicDiagnosisBean {
	 ...
	 * diagnosisBean
	 */
	public OrthopedicDiagnosisBean() {
	}

	
	/**
	 * OrthopedicDiagnosisBean
	 * @param code code
	 * @param description description
	 * @param classification classification
	 * @param URL URL
	 */
	public OrthopedicDiagnosisBean(String code, String description, String classification, String URL) {
		this.icdCode = code;
