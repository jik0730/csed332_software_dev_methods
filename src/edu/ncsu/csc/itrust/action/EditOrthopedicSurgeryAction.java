...
/**
 * Used for edit Orthopedic office visit page
 * (editOphalmologySurgeryRecord.jsp).
 * 
...
public class EditOrthopedicSurgeryAction {
	...
	/**
	 * EditOrthopedicSurgeryAction is the constructor for this action class. It
	...
	public void editOrthopedicSurgery(long oid, OrthopedicSurgeryRecordBean p)
		...
		if (p != null) {
			...
			loggingAction.logEvent(TransactionType.parse(9002), loggedInMID, p.getMid(),
					"Surgical Orthopedic Office Visit " + p.getOid() + " edited by " + loggedInMID);
		} else {
