...
public class TransactionLogDAO {
	...
	public List<TransactionLogBean> getTransactionGroupBy(TransactionLogColumnType type) throws DBException, ITrustException {
		...
		try {
			...
			s = "SELECT u1.Role as loggedInRole, u2.Role as secondaryRole, t.transactionID as transactionID, "
					+ "t.transactionCode as transactionCode, t.timeLogged as timeLogged, "
					+ "t.addedInfo as addedInfo "
	 ...
	 * @param loggedInRole MID of the logged in user
	 * @param secondaryRole MID of the logged in user
