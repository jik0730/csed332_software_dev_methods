...
/**
 * Validator class for OrthopedicScheduleOVRecordBean. Used in order to verify that a beans
 * contents are consistent with the data format section of UC88.
 */
public class OrthopedicScheduleOVValidator extends BeanValidator<OrthopedicScheduleOVRecordBean> {
	
	/** Validates an scheduled Orthopedic ov bean passed to it.
	 ...
	 */
	@Override
	public void validate(OrthopedicScheduleOVRecordBean bean) throws FormValidationException {
